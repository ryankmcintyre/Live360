...
<asp:Content ContentPlaceholderID="PlaceHolderMain" runat="server">
		...
		<div class="row">
			...
			<div class="right-wp-zone-col col-md-3">
			    <div class="ewiki-slink">
					   ...
					   <div class="welcome-content">
						   <b>
							<SharePoint:EncodedLiteral runat="server" text="<%$Resources:cms,projectpage_webpage_field_label%>" EncodeMethod="HtmlEncode"/></b><br>
						   <SharePoint:UrlField FieldName="WebPage" DisableInputFieldLabel="true" CssClass="ewiki-right-col" runat="server"/>
					   </div>
						<div class="welcome-content">
							<b>
							<SharePoint:EncodedLiteral runat="server" text="<%$Resources:cms,projectpage_contact_field_label%>" EncodeMethod="HtmlEncode"/></b><br>
							<SharePoint:UserField FieldName="PublishingContact" DisableInputFieldLabel="true" CssClass="ewiki-right-col" runat="server"/>
					   </div>
					   <div class="welcome-content">
						   <b>
							<SharePoint:EncodedLiteral runat="server" text="<%$Resources:cms,projectpage_taskstatus_field_label%>" EncodeMethod="HtmlEncode"/></b><br>
